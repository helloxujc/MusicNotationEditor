...
public class Ink implements I.Show, Serializable {
    ...
    //public static final int K = musics.UC.normSampleSize;
...
//        G.V.T.set(BUFFER.bBox,temp); // the transform we want to use
//        transform();
//        G.V.T.set(temp,BUFFER.bBox.getNewVS()); // the transform we want to use
//        transform();
